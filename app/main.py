...
from app.database import Base, engine, ensure_schema_once
...
@app.get("/club-balances")
@app.get("/club-balances.html")
def read_club_balances_page():
    return _serve_html("club-balances.html")
